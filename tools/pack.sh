...
# Pack binary
echo Packing binary...
"$rarpath" a -ep1 -r -m5 /tmp/$version-bin.rar "../Uname.NET/bin/$releaseconf/netstandard2.0/"
"$rarpath" a -ep1 -r -m5 /tmp/$version-demo.rar "../Uname.NET.Console/bin/$releaseconf/net6.0/"
if [ ! $? == 0 ]; then
